...
?>
		<tr>
			...
			<td class="standardText">
        <span style="display:none" class="input-append date span12" id="expirationdate" data-date="<?php echo date('Y-m-d', $expts); ?>" data-date-format="yyyy-mm-dd" data-date-language="<?php echo str_replace('_', '-', $this->params['session']->getLanguage()); ?>">
...
?>
		<tr>	
      <td>
			<div style="display:none" class="cbSelectTitle"><?php printMLText("workflow");?>:</div>
      </td>
      <td>
<?php
...
?>
        <select style="display:none" class="_chzn-select-deselect span9" name="workflow" data-placeholder="<?php printMLText('select_workflow'); ?>">
<?php
