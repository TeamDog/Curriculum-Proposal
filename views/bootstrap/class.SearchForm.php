...
?>
<!-- jtg mod, file does not exist?
	<form action="../op/op.Search.php" id="form1" name="form1">-->
<form action="../out/out.Search.php" id="form1" name="form1">
...
<td>
<label style="display:none" class="checkbox" for="keywords"><input type="checkbox" id="keywords" name="searchin[]" value="1"><?php printMLText("keywords");?> (<?php printMLText('documents_only'); ?>)</label>
<label class="checkbox" for="searchName"><input type="checkbox" name="searchin[]" id="searchName" value="2"><?php printMLText("name");?></label>
<label style="display:none" class="checkbox" for="comment"><input type="checkbox" name="searchin[]" id="comment" value="3"><?php printMLText("comment");?></label>
